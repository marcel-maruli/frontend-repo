...
import { useEditUser } from "@/apis/users/users";
...
export default function EditUser(props: { disableCustomTheme?: boolean }) {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const response = await useEditUser(payload, String(userId));
